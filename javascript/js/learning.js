...
console.log(minNum(2,2));
console.log(minNum(1,2));
console.log(minNum(2,3));
console.log("dog", "cat");
console.groupEnd();
...
//>>> your code goes here!
var array2 = generateRandomNumbers(5, 1, 100);
var array3 = array2.forEach(*2).map();
